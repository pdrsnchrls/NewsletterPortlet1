...
public class EventPersistenceImpl
	 ...
	 */
	@Override
	public List<Event> filterFindByEventId(long eventId) {
		return filterFindByEventId(
			eventId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Event> filterFindByEventId(long eventId, int start, int end) {
		return filterFindByEventId(eventId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Event> filterFindByEventId(
		long eventId, int start, int end,
		OrderByComparator<Event> orderByComparator) {
		...
		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			query.toString(), Event.class.getName(),
	 ...
	 */
	@Override
	public int filterCountByEventId(long eventId) {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return countByEventId(eventId);
		}
