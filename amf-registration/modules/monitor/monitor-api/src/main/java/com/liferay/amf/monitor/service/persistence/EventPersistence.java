...
public interface EventPersistence extends BasePersistence<Event> {
	 ...
	 */
	public java.util.List<Event> findByEventId(long eventId);
	 ...
	 */
	public java.util.List<Event> findByEventId(
	 ...
	 */
	public java.util.List<Event> filterFindByEventId(long eventId);
	 ...
	 */
	public java.util.List<Event> filterFindByEventId(
		long eventId, int start, int end);
