...
<liferay-ui:search-container total="${usersSize}" var="searchContainer" delta="5" deltaConfigurable="false" 
  emptyResultsMessage="there-are-no-users-in-this-area-to-display">
