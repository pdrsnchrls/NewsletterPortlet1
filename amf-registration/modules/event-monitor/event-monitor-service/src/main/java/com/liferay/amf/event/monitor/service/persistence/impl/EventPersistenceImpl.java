...
package com.liferay.amf.event.monitor.service.persistence.impl;

import com.liferay.amf.event.monitor.exception.NoSuchEventException;
import com.liferay.amf.event.monitor.model.Event;
import com.liferay.amf.event.monitor.model.impl.EventImpl;
import com.liferay.amf.event.monitor.model.impl.EventModelImpl;
import com.liferay.amf.event.monitor.service.persistence.EventPersistence;
import com.liferay.amf.event.monitor.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class EventPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.amf.event.monitor.model.Event"),
			true);
	}
