 ...
 * @see newUserServiceHttp
 * @generated
 */
@ProviderType
public class newUserServiceSoap {
	...
	private static Log _log = LogFactoryUtil.getLog(newUserServiceSoap.class);
